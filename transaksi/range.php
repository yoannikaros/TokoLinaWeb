<?php
	...
	$sql = "SELECT * from sales " . $queryCondition . " ORDER BY subtotal DESC";
...
<br>
	...
	<a href="../transaksi"><input style="margin-left:10px" class="btn btn-warning mb-4" type="submit" value="Kembali" ></a>
