						...
						<div class="row">
							...
							<div class="col-sm-5">
								...
								<div class="form-group">
									...
									<input type="text" name="pelanggan" id="pelanggan" class="form-control" value="<?php echo isset($_REQUEST['pelanggan']) ? $_REQUEST['pelanggan'] : '' ?>" placeholder="Nama pelanggan">
							...
							<div class="col-sm-5">
								...
								<div class="form-group">
									...
									<input type="text" name="lastinsetid" id="lastinsetid" class="form-control" value="<?php echo isset($_REQUEST['lastinsetid']) ? $_REQUEST['lastinsetid'] : '' ?>" placeholder="No Struk">
