...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<tr>
            ...
            <td>$row[point]</td>
            <td>
            <a target='_blank' href='edit.php?identitas=" . $row['identitas'] . "' class='btn btn-success'>Bayar Hutang</a>
            <a target='_blank' href='tambahhutang.php?identitas=" . $row['identitas'] . "' class='btn btn-warning'>Tambah Hutang</a>
