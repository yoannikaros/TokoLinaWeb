...
<body>
	...
	<br>
		...
		<center><h4>Ubah barang</h4></center>
<br>
		<?php
				...
				<div class="col-sm-60">
					...
					<form method="post">
						...
						<label>Abaikan</label>
							...
							<input readonly type="text" name="barcode" id="barcode" class="form-control" value="<?php echo isset($row[0]['barcode']) ? $row[0]['barcode'] : ''; ?>" placeholder="Enter barcode name" required>
						...
						<label>Abaikan</label>
							...
							<input readonly type="text" name="idsatuan" id="idsatuan" class="form-control" value="<?php echo isset($row[0]['idsatuan']) ? $row[0]['idsatuan'] : ''; ?>" placeholder="Enter idsatuan name" required>
