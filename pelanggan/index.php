...
<body>
    ...
    <div class="profile" style="margin-bottom: 100px;">
        ...
        <a href="kupon/index.php"><button> <b>TUKAR KUPON</b> </button> </a>
        <a href="kupon/semua.php"><button> <b>PRINT KUPON</b> </button> </a>
        <a href="alamat/index.php"><button> <b>UBAH ALAMAT & HAPUS</b> </button> </a>
        <a href="transaksi/index.php"><button> <b>CEK TRANSAKSI KONSUMEN</b> </button></a>


        <a target="_blank" href="../transaksi-konsumen/barang.php"><button> <b>CEK NOTA</b> </button> </a>
        <hr>
