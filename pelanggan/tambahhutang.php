...
if(isset($_POST['submit'])){
    ...
    $pelanggan2 = filter_input(INPUT_POST, 'pelanggan2', FILTER_SANITIZE_NUMBER_INT);
    ...
    $_SESSION['pelanggan2'] = $pelanggan2;
    ...
    $sql = "INSERT INTO pelanggan2 (nama_pelanggan, hutang) VALUES ('$nama_pelanggan', '$hutang_baru')";
    if (mysqli_query($conn, $sql)) {
        // Query berhasil, menutup koneksi ke database
        mysqli_close($conn);
        //redirect ke print.php
        header("location: print2.php?nama_pelanggan=$nama_pelanggan");
        } else {
...
<br>
<label for="hutang_baru">Tambah Hutang:</label>
<input class="form-control" type="number" required name="hutang_baru" value="">
<br>
